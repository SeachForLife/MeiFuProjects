...
import com.carl_yang.drawfile.adapter.ImageAdapter;
import com.carl_yang.drawfile.tools.DrawAttribute;
import com.carl_yang.drawfile.tools.PatternBitmapUtils;
import com.carl_yang.drawfile.view.DrawView;
import com.carl_yang.httpintent.domain.CommonDomain;
...
public class PatternActivity extends AppCompatActivity {
    ...
    private void initParams() {
        ...
        DrawProperty.BUTTON_CHOOSE = DrawAttribute.DrawStatus.CASUAL_WATER;
    ...
    public void intentPatternIssued(String pageName) {
        ...
        OkHttpUtils
                .post()//
                .url(ArtStudentApplication.commonUrl + "open/updateShowPage")//
